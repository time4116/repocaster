...
- Output: [Play the Bedrock PR Agent LangGraph briefing MP3](https://raw.githubusercontent.com/time4116/repocaster/main/docs/assets/repocaster-bedrock-pr-agent-langgraph.mp3) or [download it from the repo](docs/assets/repocaster-bedrock-pr-agent-langgraph.mp3)
